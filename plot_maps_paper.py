...
for z in (0.5, 3.0):
    for data in ('', 'all_lines_', 'galaxy'):
        ...
        file = f'outputs_cubes/pySIDES_from_uchuu_ntile_2_z{z}_dz{dz}_2.0slices_9deg2_{type}.fits'
        hdu = fits.open(file)
...
cbar_ax_greys = fig.add_axes([0.92, 0.05, 0.02, 0.35])  # [left, bottom, width, height]
